...
# T1595: Active Scanning (Inbound Port Sweep)
...
# T1592: Gather Victim Host Information (SNMP OS SysDesc Poll)
...
# T1590: Gather Victim Network Information (DNS Zone Transfer AXFR)
...
# T1589: Gather Victim Identity Information (LDAP User Enumeration)
...
#  T1591: Gather Victim Organization Information (Corporate Metadata Scraping)
...
#  T1598: Phishing for Information (Inbound Credential Harvest Attachment)
...
# T1597: Search Closed Sources (Internal Lookup Against Leak Indexer)
...
# T1596: Search Open Technical Databases (Shodan/Censys Scanner Inbound)
...
#  T1593: Search Open Websites/Domains (Outbound OSINT Target Profile)
...
#  T1594: Search Victim-Owned Websites (Directory Fuzzing)
...
#  T1608: Stage Capabilities (Outbound Tool Retrieval)
